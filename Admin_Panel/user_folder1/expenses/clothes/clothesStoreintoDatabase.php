...
$sql1 ="INSERT INTO expenses(`ID`, `First_Name`, `Type_Of_Expenses`, `Category`, `expenses`,`Date`) VALUES ('$id', '$firstname', 'clothes', '$clothes', '$clothes_exp',now() );";
