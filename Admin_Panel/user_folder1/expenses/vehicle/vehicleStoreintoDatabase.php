...
$sql1 ="INSERT INTO expenses(`ID`, `First_Name`, `Type_Of_Expenses`, `Category`, `expenses`,`Date`) VALUES ('$id', '$firstname', '$vehicle', '$vehicle1', '$vehicle_exp',now() );";
