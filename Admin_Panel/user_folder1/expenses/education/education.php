...
<body>
<form action="educationStoreintoDatabase.php" method="post">
        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <div class="form-outline form-white mb-4">
                <input type="number" id="education_exp" name ="education_exp" class="form-control form-control-lg" placeholder="Enter price" required="true"/>
