...
$sql1 ="INSERT INTO expenses(`ID`, `First_Name`, `Type_Of_Expenses`, `Category`, `expenses`,`Date`) VALUES ('$id', '$firstname', 'health', '$health', '$health_exp',now() );";
